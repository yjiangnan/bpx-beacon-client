...
from bpx.consensus.full_block_to_block_record import header_block_to_sub_block_record
from bpx.consensus.pot_iterations import (
    calculate_ip_iters,
    calculate_iterations_quality,
    calculate_sp_iters,
    is_overflow_block,
)
from bpx.consensus.vdf_info_computation import get_signage_point_vdf_info
...
from bpx.types.blockchain_format.slots import ChallengeChainSubSlot, RewardChainSubSlot
...
from bpx.types.weight_proof import (
    RecentChainData,
...
from bpx.util.chunks import chunks
...
class WeightProofHandler:
    ...
    async def get_proof_of_weight(self, tip: bytes32) -> Optional[WeightProof]:
        ...
        if tip_rec.height < self.constants.WEIGHT_PROOF_RECENT_BLOCKS:
            log.debug("chain too short for weight proof")
            return None
