...
class Err(Enum):
    ...
    INVALID_BLOCK_HASH = 36
    INVALID_PARENT_HASH = 37
    INVALID_PREV_RANDAO = 38
    INVALID_BLOCK_NUMBER = 39
    TIMESTAMP_TOO_FAR_IN_FUTURE = 40
    TIMESTAMP_TOO_FAR_IN_PAST = 41
    INVALID_EXTRA_DATA_SIZE = 42
    INVALID_GENESIS_EXTRA_DATA = 43
    INVALID_WITHDRAWALS_COUNT = 44
    INVALID_WITHDRAWAL_INDEX = 45
    INVALID_WITHDRAWAL_VALIDATOR_INDEX = 46
    INVALID_WITHDRAWAL_AMOUNT = 47
