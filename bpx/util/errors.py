...
class Err(Enum):
    ...
    INVALID_BLOCK_HASH = 37
    INVALID_PARENT_HASH = 38
    INVALID_PREV_RANDAO = 39
    INVALID_BLOCK_NUMBER = 40
    TIMESTAMP_TOO_FAR_IN_FUTURE = 41
    TIMESTAMP_TOO_FAR_IN_PAST = 42
    INVALID_EXTRA_DATA_SIZE = 43
    INVALID_GENESIS_EXTRA_DATA = 44
    INVALID_WITHDRAWALS_COUNT = 45
    INVALID_WITHDRAWAL_INDEX = 46
    INVALID_WITHDRAWAL_VALIDATOR_INDEX = 47
    INVALID_WITHDRAWAL_ADDRESS = 48
    INVALID_WITHDRAWAL_AMOUNT = 49
    
    EXECUTION_INVALID_PAYLOAD = 50
    EXECUTION_SYNCING = 51
    EXECUTION_SIDECHAIN = 52
