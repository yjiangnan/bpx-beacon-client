...
class Err(Enum):
    ...
    INVALID_PARENT_HASH = 36
    INVALID_PREV_RANDAO = 37
    INVALID_BLOCK_NUMBER = 38
    TIMESTAMP_TOO_FAR_IN_FUTURE = 39
    TIMESTAMP_TOO_FAR_IN_PAST = 40
    INVALID_EXTRA_DATA_SIZE = 41
    INVALID_GENESIS_EXTRA_DATA = 42
    INVALID_WITHDRAWALS_COUNT = 43
    INVALID_WITHDRAWAL_INDEX = 44
    INVALID_WITHDRAWAL_VALIDATOR_INDEX = 45
    INVALID_WITHDRAWAL_AMOUNT = 46
